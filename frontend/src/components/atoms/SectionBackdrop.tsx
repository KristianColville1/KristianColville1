...
export function SectionBackdrop({ src, flipX = false, flipY = false }: SectionBackdropProps) {
  ...
  const scale = useTransform(scrollYProgress, [0, 0.5, 1], [1.04, 1.1, 1.04]);
    ...
    <div ref={containerRef} className="absolute inset-0 -z-10 overflow-hidden">
      ...
      >
        <motion.img
          ...
          className="absolute inset-x-0 top-[-10%] h-[120%] w-full object-cover opacity-15 will-change-transform dark:opacity-10"
        />
      </div>
