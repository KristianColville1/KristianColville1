...
export const projects: Project[] = [
  {
    ...
    caseStudy: {
      ...
      outcome:
        'The system is in service at the training centre, delivered on the six-week schedule, and the relationship continues under a contract to maintain it.',
    },
  },
  {
  ...
  },
  {
    ...
    caseStudy: {
      ...
      outcome:
        'Clients self-serve the changes that used to be support tickets. Everything that is in the portal was created to be self-service, every feature was built from customer requirements, and the portal is in production with clients using it to manage their own live streaming systems.',
    },
  },
  {
